                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">                            
                                <a class="pull-right" href="{!! route('school.course.index',$school->id) !!}"><button class="btn btn-success">Back</button></a>
                            </div>
                        </div>
                    </div>
                        <div class="panel-body">
                            ...
                            <div class=" form"> 
                                ...
                                {!! Form::open(array('route' => ['school.course.store',$school->id] , 'method' => 'post', 'class' => 'cmxform form-horizontal tasi-form', 'files' => true)) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        {!! Form::text('code', null, array('class' => 'form-control', 'placeholder' => 'Course batch', 'required' => 'required')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    {!! Form::label('end_date', "Termination Date", array('class' => 'control-label col-lg-2')) !!}
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::submit('Add Course', array('class' => 'btn btn-success')) !!}
                                    </div>
                                </div>
