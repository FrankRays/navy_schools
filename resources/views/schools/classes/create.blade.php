                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">                            
                                <a class="pull-right" href="{!! route('school.class.index',$school->id) !!}"><button class="btn btn-success">Back</button></a>
                            </div>
                        </div>
                    </div>
                        ...
                        @include('includes.alert')
                            ...
                            <div class=" form"> 
                                ...
                                {!! Form::open(array('route' => ['school.class.store',$school->id] , 'method' => 'post', 'class' => 'cmxform form-horizontal tasi-form', 'files' => true)) !!}
